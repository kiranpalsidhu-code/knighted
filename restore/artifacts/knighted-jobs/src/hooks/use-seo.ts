...
const SITE_NAME = "KnightedJobs";
const SITE_URL = "https://theknightedjobs.com";
const DEFAULT_IMAGE = "https://theknightedjobs.com/knighted-jobs/opengraph.jpg";
const DEFAULT_TITLE = "KnightedJobs — Direct Job Listings. Real Salaries. No Noise.";
